...
const lightColors = {
  ...
  languageSelectorText: '#666',
  inputBackground: '#ffffff',
  checkboxLabelColor: '#777',
  ...
  bottomOptionTextColor: '#777',
  moreButtonBg: 'rgba(255, 255, 255, 0.2)',
  moreButtonTextColor: '#333',
  iconColor: '#666',
  checkboxBorderColor: '#999',
  checkboxBackgroundColor: 'rgba(255, 255, 255, 0.8)',
